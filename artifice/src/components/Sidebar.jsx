  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-2 space-y-4">
        ...
        <div className=" flex items-center gap-4 row-auto">
          <div>
            <img src="./about-us.png" alt="" className="h-7 w-8" />
          </div>
          <a
            href="#about"
            className="block px-3 py-2 rounded-md text-lg text-[#5D7285] font-bold"
        ...
        <div className=" flex items-center gap-4 row-auto">
          <div>
            <img src="./works.png" alt="" className="h-8 w-8" />
          </div>
          <a
            href="#works"
            className="block px-3 py-2 rounded-md text-lg text-[#5D7285] font-bold"
        ...
        <div className=" flex items-center gap-4 row-auto">
          <div>
            <img src="./Service.png" alt="" className="h-8 w-8" />
          </div>
          <a
            href="#services"
            className="block px-3 py-2 rounded-md text-lg text-[#5D7285] font-bold"
        ...
        <div className=" flex items-center gap-4 row-auto">
          <div>
            <img src="./mv.png" alt="" className="h-7 w-8" />
          </div>
          <a
            href="#mission"
            className="block px-3 py-2 rounded-md text-lg text-[#5D7285] font-bold"
        ...
        <div className=" flex items-center gap-4 row-auto">
          <div>
            <img src="./Contact.png" alt="" className="h-8 w-8" />
          </div>
          <a
            href="#contact"
            className="block px-3 py-2 rounded-md text-lg text-[#5D7285] font-bold"
