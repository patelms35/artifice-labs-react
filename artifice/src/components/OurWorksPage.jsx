...
const OurWorks = () => {
  return (
    <section className="bg-white py-10">
      <Navbar />
      <h2 className="text-center text-2xl font-bold text-blue-600 mb-6 mt-20">Project Done By Artifice Labs</h2>
      <div className="flex flex-col md:flex-row justify-center gap-6">
        {/* Card 1 */}
        <div className="max-w-sm bg-white rounded-lg overflow-hidden shadow-lg">
          <img className="w-full" src="/web-dev-work.png" alt="Web Development" />
          <div className="p-4">
        ...
        {/* Card 2 */}
        <div className="max-w-sm bg-white rounded-lg overflow-hidden shadow-lg">
          <img className="w-full" src="/app-dev-work.png" alt="Application Development" />
          <div className="p-4">
