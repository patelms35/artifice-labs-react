      ...
      <div className="relative">
        ...
        <div className="flex text-center justify-center items-center space-x-4">
          {slides.map((item, index) => (
            <div
              key={index}
              className="shadow-lg hover:drop-shadow-2xl h-[435px] w-[350px] text-black rounded-xl bg-white p-6 flex flex-col justify-between items-center border-2 border-[#E0E0E0] hover:border-[#106EEA] hover:border-opacity-40 hover:shadow-[#106EEA]/40 transition-transform duration-300 ease-in-out"
            >
        ...
        <div className="flex justify-center mt-6 lg:mt-0 lg:absolute lg:top-1/2 lg:left-0 lg:right-0 lg:flex lg:justify-between lg:px-10">
          <button
            ...
            onClick={handlePrev}
          >
            <ArrowLeft className="text-black transition duration-300 hover:bg-gray-200 hover:text-white w-12 h-12 bg-white rounded-full p-2" />
          </button>
          <button
            className="lg:absolute lg:right-[-70px] lg:top-1/2 transform lg:-translate-y-1/2 z-10"
            onClick={handleNext}
          >
            <ArrowRight className="text-black transition duration-300 hover:bg-gray-200 hover:text-white w-12 h-12 bg-white rounded-full p-2" />
          </button>
        </div>
      </div>
    </section>
