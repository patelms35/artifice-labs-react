  ...
  return (
    <section className="py-16 px-6 md:px-16 bg-gray-50 text-left">
      <div className="max-w-7xl mx-auto">
        {/* Heading */}
        <h2 className="text-3xl md:text-4xl font-syne font-bold mb-10" data-aos="fade-up"
            data-aos-delay="500" >
        ...
        {/* Paragraph */}
        <p className="text-lg text-gray-700 mb-16" data-aos="fade-up"
            data-aos-delay="600" >
        ...
        {/* Team Section */}
        <h3 className="text-2xl md:text-3xl font-syne font-bold mb-6" data-aos="fade-up"
            data-aos-delay="700" >
